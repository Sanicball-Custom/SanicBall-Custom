...
namespace Sanicball
{
    public static class GameInput
    {
        ...
        private const string joystick1Trig = "joy1-dx";
        ...
        public static bool IsJumping(ControlType ctrlType, bool holding)
        {
            switch (ctrlType)
            {
                case ControlType.Keyboard:
                    if(holding) return Input.GetKey(ActiveData.Keybinds[Keybind.Jump]) && !KeyboardDisabled;
                    else return Input.GetKeyDown(ActiveData.Keybinds[Keybind.Jump]) && !KeyboardDisabled;

                case ControlType.Joystick1:
                    if(holding) return Input.GetKey(KeyCode.Joystick1Button0);
                    else return Input.GetKeyDown(KeyCode.Joystick1Button0);

                case ControlType.Joystick2:
                    if(holding) return Input.GetKey(KeyCode.Joystick2Button0);
                    else return Input.GetKeyDown(KeyCode.Joystick2Button0);

                case ControlType.Joystick3:
                    if(holding) return Input.GetKey(KeyCode.Joystick3Button0);
                    else return Input.GetKeyDown(KeyCode.Joystick3Button0);

                case ControlType.Joystick4:
                    if(holding) return Input.GetKey(KeyCode.Joystick4Button0);
        ...
        public static bool IsOpeningMenu(ControlType ctrlType)
        {
            switch (ctrlType)
            {
                ...
                case ControlType.Mobile:
                    return GameObject.FindGameObjectWithTag("mobile").GetComponent<MobileCharacterSelect>().clicked;
            }
            return false;
        }
		
		public static bool IsUsingPowerupLeft(ControlType ctrlType)
        {
            switch (ctrlType)
            {
                case ControlType.Keyboard:
		...
		public static bool IsUsingPowerupRight(ControlType ctrlType)
        {
            switch (ctrlType)
            {
                case ControlType.Keyboard:
